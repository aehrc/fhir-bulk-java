...
class FhirUtilsTest {
  ...
  void testParseFhirInstantWithZoneZ() {
    assertEquals(FhirFormats.parseFhirInstant("2023-01-02T00:01:02.123Z"),
        Instant.parse("2023-01-02T00:01:02.123Z"));
  }

  @Test
  void testParseFhirInstantWithExplicitOffset() {
    assertEquals(FhirFormats.parseFhirInstant("2023-01-02T00:01:02.123+00:00"),
        Instant.parse("2023-01-02T00:01:02.123Z"));
  }
  ...
  void testFormatFhirInstant() {
    ...
    assertEquals("2023-01-02T00:01:02.123Z",
        FhirFormats.formatFhirInstant(Instant.parse("2023-01-02T00:01:02.123Z")));
  }
}
